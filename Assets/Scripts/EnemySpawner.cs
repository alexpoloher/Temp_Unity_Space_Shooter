...
public class EnemySpawner : MonoBehaviour
{
    ...
    private bool dejarDeSpawnearPorBoss = false;
    ...
    void Update()
    {
        ...
        {
            if (puedeSpawnear && !dejarDeSpawnearPorBoss)
            {
    ...
    //Cuando aparezca el Boss, no aparecerán más enemigos
    public void DejarDeSpawnearPorBoss()
    {
        dejarDeSpawnearPorBoss = true;
    }
